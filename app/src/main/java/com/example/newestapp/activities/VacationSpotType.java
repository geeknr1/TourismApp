...
public enum VacationSpotType {
    ...
    Courchevel(R.drawable.courchevelbackground, R.string.COURCHEVEL_locationName, R.string.COURCHEVEL_locationInfo, R.string.COURCHEVEL_skiiLocationName, R.string.COURCHEVEL_skiiLocationInfo, R.drawable.courchevelone, R.drawable.courcheveltwo, R.drawable.courchevelthree, R.drawable.courchevelfour, R.string.COURCHEVEL_skiiLocationFunFacts, R.string.COURCHEVEL_hikingLocationName, R.string.COURCHEVEL_hikingLocationInfo, R.string.COURCHEVEL_hikingLocationFunFacts, R.string.COURCHEVEL_rockClimbingLocationName, R.string.COURCHEVEL_rockClimbingLocationInfo, R.string.COURCHEVEL_rockClimbingLocationFunFacts),
    ...
    Ischgl(R.drawable.ischglbackground, R.string.ISCHGL_locationName, R.string.ISCHGL_locationInfo, R.drawable.ischglone, R.drawable.ischgltwo, R.drawable.ischglthree, R.drawable.ischglfour,R.string.ISCHGL_skiiLocationName, R.string.ISCHGL_skiiLocationInfo, R.string.ISCHGL_skiiLocationFunFacts, R.string.ISCHGL_hikingLocationName, R.string.ISCHGL_hikingLocationInfo, R.string.ISCHGL_hikingLocationFunFacts, R.string.ISCHGL_rockClimbingLocationName, R.string.ISCHGL_rockClimbingLocationInfo, R.string.ISCHGL_rockClimbingLocationFunFacts),
    Sölden(R.drawable.soldenbackground, R.string.SOLDEN_locationName, R.string.SOLDEN_locationInfo, R.drawable.soldenone, R.drawable.soldentwo, R.drawable.soldenthree, R.drawable.soldenfour ,R.string.SOLDEN_skiiLocationName, R.string.SOLDEN_skiiLocationInfo, R.string.SOLDEN_skiiLocationFunFacts, R.string.SOLDEN_hikingLocationName, R.string.SOLDEN_hikingLocationInfo, R.string.SOLDEN_hikingLocationFunFacts, R.string.SOLDEN_rockClimbingLocationName, R.string.SOLDEN_rockClimbingLocationInfo, R.string.SOLDEN_rockClimbingLocationFunFacts);
    ...
    VacationSpotType(int background, int locName, int locInfo,  int imgOne, int imgTwo, int imgThree, int imgFour, int skiiLocName, int skiiLocInfo, int skiiLocFunFacts, int hikingLocName, int hikingLocInfo, int hikingLocFunFacts, int rockClimbingLocName, int rockClimbingLocInfo, int rockClimbingLocFunFacts){
