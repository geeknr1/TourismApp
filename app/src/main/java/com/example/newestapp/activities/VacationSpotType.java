...
public enum VacationSpotType {
    Chamonix_Mont_Blanc(R.drawable.charmonixbackground,R.string.CHARMONIX_MONT_BLANC_locationName, R.string.CHARMONIX_MONT_BLANC_locationInfo, R.drawable.charmonixone, R.drawable.charmonixtwo, R.drawable.charmonixthree, R.drawable.charmonixfour ,R.string.CHARMONIX_MONT_BLANC_skiiLocationName, R.string.CHARMONIX_MONT_BLANC_skiiLocationInfo, R.drawable.charmonixskiione, R.drawable.charmonixskiitwo, R.drawable.charmonixskiithree, R.drawable.charmonixskii, R.string.CHARMONIX_MONT_BLANC_skiiLocationFunFacts, R.string.CHARMONIX_MONT_BLANC_hikingLocationName, R.string.CHARMONIX_MONT_BLANC_hikingLocationInfo, R.drawable.charmonixhike, R.drawable.charmonixhikeone, R.drawable.charmonixhiketwo, R.drawable.charmonixhikethree, R.string.CHARMONIX_MONT_BLANC_hikingLocationFunFacts, R.string.CHARMONIX_MONT_BLANC_rockClimbingLocationName, R.string.CHARMONIX_MONT_BLANC_rockClimbingLocationInfo, R.drawable.charmonixrockclimbing, R.drawable.charmonixrockclimbingtwo, R.drawable.charmonixrockclimbingthree, R.drawable.charmonixrockclimbingone, R.string.CHARMONIX_MONT_BLANC_rockClimbingLocationFunFacts, R.raw.charmonixhiking),
    Meribel(R.drawable.meribelbackground, R.string.MERIBEL_locationName, R.string.MERIBEL_locationInfo, R.drawable.meribelone, R.drawable.meribeltwo, R.drawable.meribelthree, R.drawable.meribelfour,R.string.MERIBEL_skiiLocationName, R.string.MERIBEL_skiiLocationInfo, R.drawable.meribelskiione, R.drawable.meribelskiitwo, R.drawable.meribelskiithree, R.drawable.meribelskiifour, R.string.MERIBEL_skiiLocationFunFacts, R.string.MERIBEL_hikingLocationName, R.string.MERIBEL_hikingLocationInfo, R.drawable.meribelhikingone, R.drawable.meribelhikingtwo, R.drawable.meribelhikingthree, R.drawable.meribelhikingfour, R.string.MERIBEL_hikingLocationFunFacts, R.string.MERIBEL_rockClimbingLocationName, R.string.MERIBEL_rockClimbingLocationInfo, R.drawable.meribelrockclimbingone, R.drawable.meribelrockclimbingtwo, R.drawable.meribelrockclimbingthree, R.drawable.meribelrockclimbingfour, R.string.MERIBEL_rockClimbingLocationFunFacts, R.raw.meribel),
    Courchevel(R.drawable.courchevelbackground, R.string.COURCHEVEL_locationName, R.string.COURCHEVEL_locationInfo, R.drawable.courchevelone, R.drawable.courcheveltwo, R.drawable.courchevelthree, R.drawable.courchevelfour, R.string.COURCHEVEL_skiiLocationName, R.string.COURCHEVEL_skiiLocationInfo, R.drawable.courchevelskiione, R.drawable.courchevelskiitwo, R.drawable.courchevelskiithree, R.drawable.courchevelskiifour, R.string.COURCHEVEL_skiiLocationFunFacts, R.string.COURCHEVEL_hikingLocationName, R.string.COURCHEVEL_hikingLocationInfo, R.drawable.courchevelhikingone, R.drawable.courchevelhikingtwo, R.drawable.courchevelhikingthree, R.drawable.courchevelhikingfour, R.string.COURCHEVEL_hikingLocationFunFacts, R.string.COURCHEVEL_rockClimbingLocationName, R.string.COURCHEVEL_rockClimbingLocationInfo, R.drawable.courchevelrockclimbingone, R.drawable.courchevelrockclimbingtwo, R.drawable.courchevelrockclimbingthree, R.drawable.courchevelrockclimbingfour, R.string.COURCHEVEL_rockClimbingLocationFunFacts, R.raw.courchevel),
    Val_dIsère(R.drawable.valdserebackground, R.string.VAL_DLSERVE_locationName, R.string.VAL_DLSERVE_locationInfo, R.drawable.valdsereone, R.drawable.valdseretwo, R.drawable.valdserethree, R.drawable.valdserefour ,R.string.VAL_DLSERVE_skiiLocationName, R.string.VAL_DLSERVE_skiiLocationInfo, R.drawable.valskiione, R.drawable.valskiitwo, R.drawable.valskiithree, R.drawable.valskiifour, R.string.VAL_DLSERVE_skiiLocationFunFacts, R.string.VAL_DLSERVE_hikingLocationName, R.string.VAL_DLSERVE_hikingLocationInfo, R.drawable.valhikingone, R.drawable.valhikingtwo, R.drawable.valhikingthree, R.drawable.valhikingfour, R.string.VAL_DLSERVE_hikingLocationFunFacts, R.string.VAL_DLSERVE_rockClimbingLocationName, R.string.VAL_DLSERVE_rockClimbingLocationInfo, R.drawable.valrockclimbingone, R.drawable.valrockclimbingtwo, R.drawable.valrockclimbingthree, R.drawable.valrockclimbingfour, R.string.VAL_DLSERVE_rockClimbingLocationFunFacts, R.raw.valdisere);
...
//    Sölden(R.drawable.soldenbackground, R.string.SOLDEN_locationName, R.string.SOLDEN_locationInfo, R.drawable.soldenone, R.drawable.soldentwo, R.drawable.soldenthree, R.drawable.soldenfour ,R.string.SOLDEN_skiiLocationName, R.string.SOLDEN_skiiLocationInfo, R.string.SOLDEN_skiiLocationFunFacts, R.string.SOLDEN_hikingLocationName, R.string.SOLDEN_hikingLocationInfo, R.string.SOLDEN_hikingLocationFunFacts, R.string.SOLDEN_rockClimbingLocationName, R.string.SOLDEN_rockClimbingLocationInfo, R.string.SOLDEN_rockClimbingLocationFunFacts, R.raw.solden);
    ...
    public final int skiImgOne;
    public final int skiImgTwo;
    public final int skiImgThree;
    public final int skiImgFour;
    public final int hikingImgOne;
    public final int hikingImgTwo;
    public final int hikingImgThree;
    public final int hikingImgFour;
    public final int rockClimbingImgOne;
    public final int rockClimbingImgTwo;
    public final int rockClimbingImgThree;
    public final int rockClimbingImgFour;
    public final int hikingVideo;

    VacationSpotType(int background, int locName, int locInfo,  int imgOne, int imgTwo, int imgThree, int imgFour, int skiiLocName, int skiiLocInfo, int skiiLocImgOne, int skiiLocImgTwo, int skiiLocImgThree, int skiiLocImgFour, int skiiLocFunFacts, int hikingLocName, int hikingLocInfo, int hikingLocImgOne, int hikingLocImgTwo, int hikingLocImgThree, int hikingLocImgFour, int hikingLocFunFacts, int rockClimbingLocName, int rockClimbingLocInfo, int rockClimbingImgOne, int rockClimbingImgTwo, int rockClimbingImgThree, int rockClimbingImgFour, int rockClimbingLocFunFacts, int vidHike){
        ...
        this.skiImgOne = skiiLocImgOne;
        this.skiImgTwo = skiiLocImgTwo;
        this.skiImgThree = skiiLocImgThree;
        this.skiImgFour = skiiLocImgFour;
        this.hikingImgOne = hikingLocImgOne;
        this.hikingImgTwo = hikingLocImgTwo;
        this.hikingImgThree = hikingLocImgThree;
        this.hikingImgFour = hikingLocImgFour;
        this.rockClimbingImgOne = rockClimbingImgOne;
        this.rockClimbingImgTwo = rockClimbingImgTwo;
        this.rockClimbingImgThree = rockClimbingImgThree;
        this.rockClimbingImgFour = rockClimbingImgFour;
